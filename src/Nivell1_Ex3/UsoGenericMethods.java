...
public class UsoGenericMethods {
	...
	GenericMethods usoGenerico = new GenericMethods();
		...
		int int2 = 2;
		int int3 = 3;
		System.out.println(usoGenerico.f(int1, int2, Integer.toString(int3)));
		...
		System.out.println(usoGenerico.f(alum1, alum2, alum3.toString()));
		
		System.out.println("Uso el método genérico f() con diferentes tipos");
		System.out.println(usoGenerico.f(string1,int2 , alum3.toString()));
